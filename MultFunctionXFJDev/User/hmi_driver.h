...
#define  START_FONT   	 				6   		//链接网络时提示字体
#define  SYS_TMP_FONT 	 				6				//开机系统信息提示字体
#define  ASCII_06X12  					0				//开机系统信息提示字体
#define  ASCII_08X12  					1				//开机系统信息提示字体
#define  ASCII_12X24  					2				//开机系统信息提示字体
#define  ASCII_16X32  					3				//开机系统信息提示字体
#define  GBK_12X12  						4				//开机系统信息提示字体
#define  GBK_16X16  						5				//开机系统信息提示字体
#define  GBK_24X24  						6				//开机系统信息提示字体
#define  GBK_32X32							7				//开机系统信息提示字体
#define  GBK_32X64							8				//开机系统信息提示字体
#define  GBK_64X64							9				//开机系统信息提示字体
#define  SYS_LOG_FONT  					1				//开机系统信息提示字体
#define  ASCII8X16  						1				//开机系统信息提示字体
#define  X_START_pos   					40  		//开机系统提示信息x开始坐标
#define  Y_gas  								30  		//开机系统提示信息y轴间隔



#define  TOOL_BAR_FONT 	 				GBK_16X16				//开机系统信息提示字体
